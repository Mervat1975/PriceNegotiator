        ...
        for qu in questions:
            ...
            if (qu.qu_type == "O"):
                ...
                if (n == 0):
                    ...
                    data.append((TextResponse.objects.filter(qu_id=qu).filter(
                        txt_res_sentiment='positive').filter(txt_res_date__gt=past_date)).count())
                ...
                if (n == 0):
                    ...
                    data.append((TextResponse.objects.filter(qu_id=qu).filter(
                        txt_res_sentiment='negative').filter(txt_res_date__gt=past_date)).count())
            else:
                ...
                for qu_op in qu_ops:
                    ...
                    if (n == 0):
                        ...
                        data.append(
                            (OptionResponse.objects.filter(op_id=qu_op).filter(op_res_date__gt=past_date)).count())
